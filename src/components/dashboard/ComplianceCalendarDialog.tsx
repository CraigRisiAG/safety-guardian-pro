  ...
  return (
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      <DialogTrigger asChild>
        <button className="flex flex-col items-center gap-2 sm:gap-3 p-4 sm:p-6 rounded-xl bg-accent hover:bg-accent/80 transition-colors cursor-pointer col-span-2">
